        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body" ng-controller="postCtrl">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url("/research/$post->id") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="body" type="text" class="form-control" name="body" required>{{ $post->body }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('file_<% $index %>') ? ' has-error' : '' }}">
                            <label for="file_<% $index %>" class="col-md-4 control-label">Add files</label>
