                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('locale') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Preferred language</label>

                            <div class="col-md-6">
                                <label><input id="locale" type="radio" name="locale" value="en" checked> English</label> <br>
                                <label><input id="locale" type="radio" name="locale" value="es"> Español</label>
